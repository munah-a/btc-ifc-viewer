...
export const en = {
  ...
  'status.searchSetCreated': 'Search set "{name}" saved ({count} elements)',
  'status.searchSetDeleted': 'Search set "{name}" deleted',
  'status.searchSetHidden': 'Search set "{name}" hidden',
  'status.searchSetShown': 'Search set "{name}" shown',
  'status.searchSetColorOn': 'Color override on for "{name}"',
  'status.searchSetColorOff': 'Color override off for "{name}"',
  'status.searchSetSelected': 'Search set "{name}" selected',
  'status.searchSetEmpty': 'No search results to save as a set',
  ...
  'status.sessionSaved': 'Session saved ({count} models)',
  'status.sessionRestored': 'Session restored ({count} models)',
  'status.sessionModelsMissing': '{count} cached models could not be restored',
  'status.sessionCleared': 'Saved session cleared',
  'status.noSessionToRestore': 'No saved session to restore',
  'status.sessionSaveFailed': 'Could not save the session: {error}',
  ...
  'share.title': 'Share',
  'share.exportGlb': 'Export GLB (for PowerPoint 3D)',
  'share.copyLink': 'Copy link to view',
  'share.linkCopied': 'Link copied to clipboard',
  'share.copyFailed': 'Could not copy — copy the link manually',
  'share.hostTitle': 'Host & embed',
  'share.hostIntro': 'Publish the current model to a shareable link and embed. Free links expire after {days} days.',
  'share.publish': 'Publish & create link',
  'share.publishing': 'Converting and uploading…',
  'share.published': 'Published. Your link is ready.',
  'share.publishFailed': 'Publishing failed: {error}',
  'share.needModel': 'Load a model before sharing.',
  'share.embedLink': 'Embed link',
  'share.iframeSnippet': 'Embed code (iframe)',
  'share.copyIframe': 'Copy embed code',
  'share.qrTitle': 'QR code',
  'share.expiresOn': 'Expires on {date}',
  'share.deleteUpload': 'Delete this upload',
  'share.deleteConfirm': 'Delete this shared upload? The link and embed will stop working immediately.',
  'share.deleted': 'Upload deleted',
  'share.deleteFailed': 'Delete failed: {error}',
  'share.close': 'Close',
  'share.tabLink': 'Link & embed',
  'share.tabPowerpoint': 'PowerPoint',
  'share.ppTitle': 'Add this model to PowerPoint',
  'share.ppWebViewer': 'Online (Microsoft 365): Insert → Add-ins → Web Viewer, then paste the embed link above.',
  'share.ppGlb': 'Offline decks: use Export GLB, then in PowerPoint choose Insert → 3D Models → This Device and pick the .glb file.',
  'share.glbExporting': 'Preparing GLB…',
  'share.glbExported': 'GLB exported',
  'share.glbFailed': 'GLB export failed: {error}',
  'share.glbClippingWarning': 'Note: section-clipped geometry is still included in the GLB.',
  'share.glbNoModel': 'Load a model before exporting.',
  ...
  'shell.saveSession': 'Save session',
  'shell.restoreSession': 'Restore session',
  ...
  'shell.saveSearchSet': 'Save as set',
  'shell.saveSearchSetTitle': 'Save this search as a set (color override + hide/show)',
  'shell.searchSets': 'Search sets',
  'set.count': '{count} elements',
  'set.colorOn': 'Apply color override',
  'set.colorOff': 'Remove color override',
  'set.hide': 'Hide set elements',
  'set.show': 'Show set elements',
  'set.select': 'Select set elements',
  'set.delete': 'Delete set',
...
export const de: Record<MessageKey, string> = {
  ...
  'status.searchSetCreated': 'Suchset «{name}» gespeichert ({count} Elemente)',
  'status.searchSetDeleted': 'Suchset «{name}» gelöscht',
  'status.searchSetHidden': 'Suchset «{name}» ausgeblendet',
  'status.searchSetShown': 'Suchset «{name}» eingeblendet',
  'status.searchSetColorOn': 'Farbmarkierung für «{name}» aktiviert',
  'status.searchSetColorOff': 'Farbmarkierung für «{name}» deaktiviert',
  'status.searchSetSelected': 'Suchset «{name}» ausgewählt',
  'status.searchSetEmpty': 'Keine Suchergebnisse zum Speichern als Set',
  ...
  'status.sessionSaved': 'Sitzung gespeichert ({count} Modelle)',
  'status.sessionRestored': 'Sitzung wiederhergestellt ({count} Modelle)',
  'status.sessionModelsMissing': '{count} zwischengespeicherte Modelle konnten nicht wiederhergestellt werden',
  'status.sessionCleared': 'Gespeicherte Sitzung gelöscht',
  'status.noSessionToRestore': 'Keine gespeicherte Sitzung vorhanden',
  'status.sessionSaveFailed': 'Sitzung konnte nicht gespeichert werden: {error}',
  ...
  'share.title': 'Teilen',
  'share.exportGlb': 'GLB exportieren (für PowerPoint 3D)',
  'share.copyLink': 'Link zur Ansicht kopieren',
  'share.linkCopied': 'Link in die Zwischenablage kopiert',
  'share.copyFailed': 'Kopieren fehlgeschlagen — Link manuell kopieren',
  'share.hostTitle': 'Hosten & einbetten',
  'share.hostIntro': 'Aktuelles Modell als teilbaren Link und Einbettung veröffentlichen. Kostenlose Links laufen nach {days} Tagen ab.',
  'share.publish': 'Veröffentlichen & Link erstellen',
  'share.publishing': 'Wird konvertiert und hochgeladen…',
  'share.published': 'Veröffentlicht. Ihr Link ist bereit.',
  'share.publishFailed': 'Veröffentlichung fehlgeschlagen: {error}',
  'share.needModel': 'Vor dem Teilen ein Modell laden.',
  'share.embedLink': 'Einbettungslink',
  'share.iframeSnippet': 'Einbettungscode (iframe)',
  'share.copyIframe': 'Einbettungscode kopieren',
  'share.qrTitle': 'QR-Code',
  'share.expiresOn': 'Läuft ab am {date}',
  'share.deleteUpload': 'Diesen Upload löschen',
  'share.deleteConfirm': 'Diesen geteilten Upload löschen? Link und Einbettung funktionieren sofort nicht mehr.',
  'share.deleted': 'Upload gelöscht',
  'share.deleteFailed': 'Löschen fehlgeschlagen: {error}',
  'share.close': 'Schliessen',
  'share.tabLink': 'Link & Einbettung',
  'share.tabPowerpoint': 'PowerPoint',
  'share.ppTitle': 'Dieses Modell in PowerPoint einfügen',
  'share.ppWebViewer': 'Online (Microsoft 365): Einfügen → Add-Ins → Web Viewer, dann den Einbettungslink oben einfügen.',
  'share.ppGlb': 'Offline-Präsentationen: GLB exportieren, dann in PowerPoint Einfügen → 3D-Modelle → Aus dieser Datei die .glb-Datei wählen.',
  'share.glbExporting': 'GLB wird vorbereitet…',
  'share.glbExported': 'GLB exportiert',
  'share.glbFailed': 'GLB-Export fehlgeschlagen: {error}',
  'share.glbClippingWarning': 'Hinweis: durch Schnitte entfernte Geometrie ist im GLB weiterhin enthalten.',
  'share.glbNoModel': 'Vor dem Export ein Modell laden.',
  ...
  'shell.saveSession': 'Sitzung speichern',
  'shell.restoreSession': 'Sitzung wiederherstellen',
  ...
  'shell.saveSearchSet': 'Als Set speichern',
  'shell.saveSearchSetTitle': 'Diese Suche als Set speichern (Farbmarkierung + Ein-/Ausblenden)',
  'shell.searchSets': 'Suchsets',
  'set.count': '{count} Elemente',
  'set.colorOn': 'Farbmarkierung anwenden',
  'set.colorOff': 'Farbmarkierung entfernen',
  'set.hide': 'Set-Elemente ausblenden',
  'set.show': 'Set-Elemente einblenden',
  'set.select': 'Set-Elemente auswählen',
  'set.delete': 'Set löschen',
