...
export function createDomCache() {
  return {
    ...
    // Share dialog (W4.4)
    shareDialog: required<HTMLDialogElement>('shareDialog'),
    shareClose: required<HTMLButtonElement>('shareClose'),
    shareTabLink: required<HTMLButtonElement>('shareTabLink'),
    shareTabPp: required<HTMLButtonElement>('shareTabPp'),
    sharePanelLink: required<HTMLDivElement>('sharePanelLink'),
    sharePanelPp: required<HTMLDivElement>('sharePanelPp'),
    shareCopyLink: required<HTMLButtonElement>('shareCopyLink'),
    sharePublish: required<HTMLButtonElement>('sharePublish'),
    sharePublished: required<HTMLDivElement>('sharePublished'),
    shareEmbedUrl: required<HTMLInputElement>('shareEmbedUrl'),
    shareCopyEmbed: required<HTMLButtonElement>('shareCopyEmbed'),
    shareIframe: required<HTMLTextAreaElement>('shareIframe'),
    shareCopyIframe: required<HTMLButtonElement>('shareCopyIframe'),
    shareQr: required<HTMLCanvasElement>('shareQr'),
    shareExpiry: required<HTMLParagraphElement>('shareExpiry'),
    shareDelete: required<HTMLButtonElement>('shareDelete'),
    shareHostIntro: required<HTMLParagraphElement>('shareHostIntro'),
    sharePpGlb: required<HTMLButtonElement>('sharePpGlb'),
  };
}
