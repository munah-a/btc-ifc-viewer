...
export function createDomCache() {
  return {
    ...
    btnSaveSearchSet: required<HTMLButtonElement>('btnSaveSearchSet'),
    searchSetsGroup: required<HTMLDivElement>('searchSetsGroup'),
    searchSetList: required<HTMLDivElement>('searchSetList'),
